...
/// of hit testing — clicks land on the duck instead of on the desktop underneath.
/// </remarks>
...
internal static class ClickThroughNative
{
    ...
    public static void Apply(IntPtr hwnd)
    {
        ...
        // uniform fade"; the duck's own translucency comes from how it is drawn.
    ...
    /// startup gets you a duck that is on top until the first time somebody clicks the
