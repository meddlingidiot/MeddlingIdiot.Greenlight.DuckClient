...
/// <summary>
/// Whether the duck comes back when Windows does. One value under the current user's
...
/// <c>duck.json</c>: the user can turn the same thing off in Task Manager's Startup tab or
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Duck";

    /// <summary>Whether Windows is currently set to start the duck.</summary>
    ...
    /// <summary>Ask Windows to start the duck, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.DuckClient\current\Greenlight.DuckClient.exe</c>,
